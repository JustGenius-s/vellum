...
const editorTheme = EditorView.theme(
  {
    ...
    ".cm-content": {
      ...
      padding: "clamp(1.5rem, 4vw, 3.5rem) clamp(1rem, 4vw, 4.5rem) 8rem",
    },
    ".cm-line": {
      maxWidth: "92ch",
    ...
    "&.cm-focused .cm-selectionBackground, .cm-selectionBackground, ::selection": {
      backgroundColor: "color-mix(in oklab, var(--signal) 24%, transparent)",
    },
    ".cm-gutters": {
      backgroundColor: "color-mix(in oklab, var(--background) 84%, transparent)",
      borderRight: "1px solid color-mix(in oklab, var(--border) 64%, transparent)",
      color: "var(--muted-foreground)",
      paddingTop: "clamp(1.5rem, 4vw, 3.5rem)",
    },
    ".cm-lineNumbers .cm-gutterElement": {
      minWidth: "3.4rem",
      paddingInline: "0.9rem 0.7rem",
      fontFamily: "var(--font-mono)",
      fontSize: "10px",
    },
    ".cm-activeLine": {
      backgroundColor: "color-mix(in oklab, var(--signal) 5%, transparent)",
      boxShadow: "inset 2px 0 0 color-mix(in oklab, var(--signal) 52%, transparent)",
    },
    ".cm-activeLineGutter": {
      backgroundColor: "color-mix(in oklab, var(--signal) 8%, transparent)",
      color: "var(--signal)",
    },
    ".cm-panels": {
    ...
    ".cm-tooltip-autocomplete ul li[aria-selected]": {
      backgroundColor: "color-mix(in oklab, var(--signal) 15%, transparent)",
      color: "var(--signal)",
    },
    ".cm-searchMatch": {
      backgroundColor: "color-mix(in oklab, var(--signal) 18%, transparent)",
      outline: "1px solid color-mix(in oklab, var(--signal) 42%, transparent)",
    },
  },
  { dark: true },
);
